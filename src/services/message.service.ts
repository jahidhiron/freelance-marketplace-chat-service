...
import { IConversationDocument, IMessageDetails, IMessageDocument, lowerCase } from '@jahidhiron/jobber-shared';
...
export const addMessage = async (data: IMessageDocument): Promise<IMessageDocument> => {
  const message = (await MessageModel.create(data)) as IMessageDocument;
